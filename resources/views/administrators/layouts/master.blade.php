...
<head>
    ...
    <!-- Fav Icon -->
    <link rel="icon" href="{{asset('assets')}}/cdn/shop/files/logo/apple-icon-114x114.png"/>
...
@endif
    ...
    <script src="{{asset('assets')}}/js/jquery.min.js"></sp>
    <script src="{{asset('assets')}}/js/jquery-migrate.js"></scrip>
